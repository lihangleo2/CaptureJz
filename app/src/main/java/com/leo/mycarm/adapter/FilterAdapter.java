package com.leo.mycarm.adapter;
...
import com.leo.mycarm.gpufilter.helper.FilterTypeHelper;
...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.FilterHolder> {
    ...
    public FilterHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.text_point = view.findViewById(R.id.text_point);
        return viewHolder;
    }
