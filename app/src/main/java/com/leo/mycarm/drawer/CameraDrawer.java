...
import com.leo.mycarm.filter.AFilter;
import com.leo.mycarm.filter.CameraFilter;
import com.leo.mycarm.filter.GroupFilter;
import com.leo.mycarm.filter.NoFilter;
import com.leo.mycarm.filter.ProcessFilter;
import com.leo.mycarm.filter.WaterMarkFilter;
import com.leo.mycarm.gpufilter.SlideGpuFilterGroup;
import com.leo.mycarm.gpufilter.filter.MagicBeautyFilter;
import com.leo.mycarm.record.video.TextureMovieEncoder;
import com.leo.mycarm.utils.EasyGlUtils;
import com.leo.mycarm.utils.MatrixUtils;
...
//    public void setLvjLeo(int lvCurrentIndex){
//        mSlideFilterGroup.setCurIndex(lvCurrentIndex);
//    }
...
//        mBeautyFilter = new MagicAntiqueFilter();
        ...
        waterMarkFilter.setWaterMark(BitmapFactory.decodeResource(resources, R.mipmap.solink_shuiy));//这里是加录制视频水印。换个图片试试
