...
import com.leo.mycarm.filter.RotationOESFilter;
...
public class VideoDrawer implements GLSurfaceView.Renderer {
    ...
    public void setLvjLeo(MagicFilterType filterType) {
        mSlideFilterGroup.setCurIndex(filterType);
//        setGpuFilter(new MagicCoolFilter());
        Log.e("我走了吗", "yes");
    }
...
//        MatrixUtils.flip(OM,false,true);//矩阵上下翻
//        mShow.setMatrix(OM);
